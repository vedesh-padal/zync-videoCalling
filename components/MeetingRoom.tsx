...
const MeetingRoom = () => {
    ...
    <section className='relative h-screen w-full overflow-hidden pt-4 text-white'>
        <div className='relative flex size-full items-center justify-center'>
            <div className='fles size-full max-w-[1000px] items-center'>
                <CallLayout />
            </div>
        ...
        <div className='fixed bottom-0 flex w-full items-center justify-center gap-x-5 flex-wrap gap-y-0 pb-2'>
